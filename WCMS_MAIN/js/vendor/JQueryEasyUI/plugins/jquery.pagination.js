...
(function ($) {
    function _1(_2) {
        ...
        function _6(_7) {
            ...
            if (_7 == "first") {
                a = $("<a href=\"javascript:void(0)\" title='First'></a>").appendTo(tr);
            }
            else if (_7 == "prev") {
                a = $("<a href=\"javascript:void(0)\" title='Previous'></a>").appendTo(tr);
            }
            else if (_7 == "next") {
                a = $("<a href=\"javascript:void(0)\" title='Next'></a>").appendTo(tr);
            }
            else if (_7 == "last") {
                a = $("<a href=\"javascript:void(0)\" title='Last'></a>").appendTo(tr);
            }
            else if (_7 == "refresh") {
                a = $("<a href=\"javascript:void(0)\" title='Refresh'></a>").appendTo(tr);
            }
            else {
        ...
        //Part for Page Number Option Start
        //if (_4.showPageList) {
        ...
        //}
        //Part for Page Number Option End
        ...
        //Added for search
        $("<td><a href=\"javascript:void(0)\" class=\"l-btn l-btn-plain\"><div class=\"searchbox-button\" onclick='showSearch()' title='Search'></div></a></td>").appendTo(tr);
    ...
    $.fn.pagination.defaults = { total: 1, pageSize: 11, pageNumber: 1, pageList: [11, 22, 33, 50], loading: false, buttons: null, showPageList: true, showRefresh: true, onSelectPage: function (_21, _22) {
        ...
        //////////////changed by fahim on 07/FEB/2018 mantis #4516
